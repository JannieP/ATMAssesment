...
public class ATMLoggingConfiguration {
    ...
    public Filter loggingFilter() {
        return new OncePerRequestFilter() {
            final boolean includeContent = logger.isDebugEnabled();
            final int maxPayloadLength = 99999;

            protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
                final boolean doLog = logger.isInfoEnabled() && !isAsyncDispatch(request);
            ...
            private void afterRequest(HttpServletRequest request, HttpServletResponse response, long ms, boolean ok) {
                try {
                    StringBuilder buf = new StringBuilder();
                    buf.append("end. ");
                    buf.append("[").append(StringUtils.rightPad(callId(request), 12)).append("] ");
            ...
            private String callId(HttpServletRequest request) {
